...
public class LanguagesLoader
{
    ...
    using var httpClient = new HttpClient();
        var response = await httpClient.GetAsync("https://www.loc.gov/standards/iso639-2/php/code_list.php");
        ...
        foreach (var item in data)
        {
            ...
            var name = regex.Replace(names[^1], "").Replace("languages", "").Replace('�','u').Trim();
